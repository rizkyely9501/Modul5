...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        case R.id.B_search:
                ...
                if(!location.equals("")) {
                    ...
                    Toast.makeText(this, "please fill with a location name ... ", Toast.LENGTH_SHORT).show();
                }
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyD7vOo6pOhDpEzCMKplT6WfkMhpXSZSViE");

        Log.d("Maps Activity", "url = "+googlePlaceUrl.toString());
